...
//Toggle Description and History Beer Tabs
$(function(){
  $('ul.tabs li').on('click',function(){
    
  	//Find Active tab and remove active class
    $('ul.tabs li.active').removeClass('active');
    //Apply Active class to clicked tab
    $(this).toggleClass('active');
    //Find Paragraph to show based on data filter attribute
    var toShow = $(this).attr('data-filter');
    var wrap = $(this).closest('.tabs-wrap');
    //Find current active p element and remove active class
    wrap.find('p.active').removeClass('active');
    //Add active class to appropriate p element
    wrap.find('p.' + toShow).addClass('active');
  })

//age check function call
  //$.ageCheck();
});
 ...
 */
 ...
 //Not currently being used but left for possible future use 12/1
/*
(function ($){   
    ...
    $.ageCheck = function(options) {
        ...
        var settings = $.extend({
            ...
            copy : 'Welcome to Boese Brothers Brewery'
        }, options);
        ...
        var _this = {
            ...
            handleSuccess : function(){                
                var successMsg = '<h3>Thanks!</h3><p>Come on in...</p>';
        ...
        $('.ac-container button').on('click', function(){
            ...
            if (_this.validate() === true) {
                ...
                if(_this.age >= settings.minAge){
                    ...
                    _this.displayErrors();
                    setTimeout(function(){
                        window.location.replace('age-limit.html');
                    }, 2000);
